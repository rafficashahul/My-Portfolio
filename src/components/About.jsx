        ...
        <div className={styles.grid}>
          <div className={styles.bio}>
            ...
            <p className={styles.bioText}>
              ...
              Frontend Development. I am passionate about building responsive
            ...
            <p className={styles.bioText}>
              Motivated and eager to learn with a great interest in technology
              and development. I enjoy learning new technologies and developing
              my skills continuously. Social and positive, with a strong ability
